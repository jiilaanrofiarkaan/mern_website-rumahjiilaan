...
mongoose.connect(process.env.MONGODB_URI || "mongodb://0.0.0.0:27017/RumahJiilaan", {
    useNewUrlParser: true,
    useUnifiedTopology: true
}, () => {
    console.log("Connect to RumahJiilaan local database")
})
...
app.listen(PORT, () => {
    console.log(`server running on localhost RumahJiilaan`);
  });